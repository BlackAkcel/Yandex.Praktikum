# [Определение выгодного тарифа для телеком компании](https://github.com/BlackAkcel/Yandex.Praktikum/blob/main/Stat/stat.ipynb)
## Сферы деятельности
Телеком
...
1. Распределение действий пользователей в зависимости от тарифа и месяца.
2. Популярность тех или иных действий в разных тарифах.
3. Был выявлен наиболее популярный тариф у пользователей.
